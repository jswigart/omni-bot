...
typedef rectDef_t UI_Rectangle;

// FIXME: do something to separate text vs window stuff
typedef struct {
	UI_Rectangle rect;                 // client coord rectangle
	UI_Rectangle rectClient;           // screen coord rectangle
	const char *name;               //
	const char *model;              //
	...
	UI_Rectangle rectEffects;          // for various effects
	UI_Rectangle rectEffects2;         // for various effects
...
typedef struct itemDef_s {
	...
	UI_Rectangle textRect;             // rectangle the text ( if any ) consumes
