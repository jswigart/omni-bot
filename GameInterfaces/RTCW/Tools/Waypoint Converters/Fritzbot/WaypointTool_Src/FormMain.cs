...
namespace WaypointTool
{
	public class FormMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.mnuPrintPreview.Text = "Con&vert";
            ...
            // lblCredits
            // 
            this.lblCredits.Font = new System.Drawing.Font("Microsoft Sans Serif", 15.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // mnuExport
            // 
            this.mnuExport.Index = 6;
            this.mnuExport.Text = "Ex&port";
		...
		private void SetActiveControl(UserControl control) 
		{
            try
            {
                ...
                if (control is IExportableUserControl)
                {
		...
		private void InitializeEditor() 
		{
            ...
            if (_reader != null)
            {
                _editor.InitializeFromReader(_reader, isNew);
            }
		}
		...
		{
            //try to open last nav file first -crapshoot
            openLastNav();
			//InitializeWaypoints(false);
		}
        ...
        private void mnuExport_Click(object sender, EventArgs e)
        {
            try
            {
                CsvWriter writer = ((IExportableUserControl)_activeControl).GetCsvWriter();
                //writer.Write("c:\\test_export.csv");
                saveFileDialog.Filter = "Comma Separated Value Files (*.csv)|*.csv";

                DialogResult result = saveFileDialog.ShowDialog(this);
                if (result == DialogResult.OK)
                {
                    writer.Write(saveFileDialog.FileName);
                    MessageBox.Show(this, "Saved " + saveFileDialog.FileName, "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }

            }
            catch (Exception ex)
            {
                MessageBox.Show(this, "Unable to export. " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
	}
}
