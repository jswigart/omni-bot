...
namespace WaypointTool
{
	public class NodeControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeGridStyle() 
		{
            ...
            DataGridTextBoxColumn positionXColumn = new DataGridTextBoxColumn();
            positionXColumn.HeaderText = "PositionX";
            positionXColumn.MappingName = "PositionX";
            ts.GridColumnStyles.Add(positionXColumn);

            DataGridTextBoxColumn positionYColumn = new DataGridTextBoxColumn();
            positionYColumn.HeaderText = "PositionY";
            positionYColumn.MappingName = "PositionY";
            ts.GridColumnStyles.Add(positionYColumn);

            DataGridTextBoxColumn positionZColumn = new DataGridTextBoxColumn();
            positionZColumn.HeaderText = "PositionZ";
            positionZColumn.MappingName = "PositionZ";
            ts.GridColumnStyles.Add(positionZColumn);
