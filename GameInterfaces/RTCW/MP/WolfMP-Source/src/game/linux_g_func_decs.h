...
// TTimo: dropping const prototype
...
extern void Svcmd_SwapTeams_f ( ) ;
extern void Svcmd_ResetMatch_f ( ) ;
extern void Svcmd_StartMatch_f ( ) ;
...
extern void mg42_muzzleflash ( gentity_t * ent ) ;
