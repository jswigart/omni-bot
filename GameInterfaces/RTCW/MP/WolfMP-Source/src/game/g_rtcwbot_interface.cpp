	...
	case ET_PLAYER:
		{
			...
			return (_ent->client->sess.playerType == _ent->client->sess.latchPlayerType) 
					? Bot_PlayerClassGameToBot(_ent->client->sess.playerType) 
					: Bot_PlayerClassGameToBot(_ent->client->sess.latchPlayerType);		
		}
	case ET_ITEM:
		{				
