...
//	{ &cg_smoothClients, "cg_smoothClients", "0", CVAR_USERINFO | CVAR_ARCHIVE},
	...
	{ &cg_waterRevive, "g_waterRevive", "0", 0 },	//communicated by systeminfo
	...
	{ &cg_centerView, "g_centerview", "0", 0 }, //communicated by systeminfo
	...
	{ &cg_fraglimit, "fraglimit", "0", 0 }, //communicated by systeminfo
	{ &cg_deathmatch, "g_deathmatch", "0", 0 }, //communicated by systeminfo
	{ &cg_drawDmScore, "cg_drawDmScore", "0", CVAR_ARCHIVE },
};
...
// JPW NERVE -- commented out 'cause this moved
	...
	// cs: so this eventually crashes the game at
	// trap_R_RenderScene call in CG_DrawActive
	//CG_InitWorldText();
}
