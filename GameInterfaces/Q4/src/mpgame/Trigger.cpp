...
void idTrigger_Multi::HandleControlZoneTrigger()
{
	...
	if(controllingTeam != prevZoneController)
	{
		...
		case DZ_NONE:
			...
			break;
		case DZ_TAKEN:
			pSituationName = "Taken";
			break;
		case DZ_LOST:
			pSituationName = "Lost";
			break;
		case DZ_DEADLOCK:
			pSituationName = "Deadlocked";
			break;
		case DZ_MARINES_TAKEN:
			pSituationName = "Marines taken";
			break;
		case DZ_MARINES_LOST:
			pSituationName = "Marines lost";
			break;
		case DZ_STROGG_TAKEN:
			pSituationName = "Strogg taken";
			break;
		case DZ_STROGG_LOST:
			pSituationName = "Strogg lost";
			break;
		case DZ_MARINE_TO_STROGG:
			pSituationName = "Marine to Strogg";
			break;
		case DZ_STROGG_TO_MARINE:
			pSituationName = "Strogg to Marine";
			break;
		case DZ_MARINE_DEADLOCK:
			pSituationName = "Marine deadlock";
			break;
		case DZ_STROGG_DEADLOCK:
			pSituationName = "Strogg deadlock";
			break;
		case DZ_MARINE_REGAIN:
			pSituationName = "Marines regain";
			break;
		case DZ_STROGG_REGAIN:
			pSituationName = "Strogg regain";
			break;
		}
		...
		{
			TriggerInfo ti;
			ti.m_Entity = HandleFromEntity(this);
			idStr::snPrintf(ti.m_TagName, TriggerBufferSize,
				"%s: %s", pSituationName, name.c_str());
			idStr::snPrintf(ti.m_Action, TriggerBufferSize,
				pSituationName);
