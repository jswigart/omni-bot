...
int main(int argc,const char **argv)
{
	...
	const char *stringresult = 0;

	gmCall call;
	if (call.BeginGlobalFunction( &machine, "getString" ))
	{
		call.End();
		call.GetReturnedString( stringresult );
	}
	MessageBox (NULL, stringresult, "Script Response:", MB_OK);
