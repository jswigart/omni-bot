...
namespace ClipperLib {
	...
	public:
		...
		bool AddPolygons( const Polygons::const_iterator itFirst, Polygons::const_iterator itEnd, PolyType polyType );
		virtual void Clear();
		IntRect GetBounds();
	protected:
	...
	public:
		...
		size_t GetNumPolysOut() const { return m_PolyOuts.size(); }
		bool GetPolyOut( int index, Polygon &poly, bool & isHole ) const;

		const PolyOutList & GetPolysOut() const { return m_PolyOuts; }
