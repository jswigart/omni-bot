...
if (${XCODE_VERSION_MAJOR} == "0300") then
    cp -fp "${SRCROOT}"/build/Default/libWm5Imagics.dylib ../SDK/Library/ReleaseDLL/libWm5Imagics.dylib
endif
if (${XCODE_VERSION_MAJOR} == "0400") then
    cp -fp "${BUILT_PRODUCTS_DIR}"/libWm5Imagics.dylib ../SDK/Library/ReleaseDLL/libWm5Imagics.dylib
endif
