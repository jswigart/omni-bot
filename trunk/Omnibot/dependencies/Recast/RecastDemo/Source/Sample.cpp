...
void Sample::resetCommonSettings()
{
	...
	m_edgeMaxLen = 64.0f;
	m_edgeMaxError = 64.0f;
	m_vertsPerPoly = 6.0f;
	m_detailSampleDist = 16.0f;
	m_detailSampleMaxError = 8.0f;
...
void Sample::handleCommonSettings()
{
	...
	imguiSlider("Cell Size", &m_cellSize, 0.1f, 128.0f, 0.01f);
	imguiSlider("Cell Height", &m_cellHeight, 0.1f, 128.0f, 0.01f);
	...
	imguiSeparator();
	imguiLabel("Agent");
	imguiSlider("Height", &m_agentHeight, 0.1f, 128.0f, 0.1f);
	imguiSlider("Radius", &m_agentRadius, 0.0f, 128.0f, 0.1f);
	imguiSlider("Max Climb", &m_agentMaxClimb, 0.1f, 128.0f, 0.1f);
	...
	imguiSlider("Max Edge Length", &m_edgeMaxLen, 0.0f, 4096.0f, 1.0f);
	imguiSlider("Max Edge Error", &m_edgeMaxError, 0.1f, 128.0f, 0.1f);
	imguiSlider("Verts Per Poly", &m_vertsPerPoly, 3.0f, 12.0f, 1.0f);		

	imguiSeparator();
	imguiLabel("Detail Mesh");
	imguiSlider("Sample Distance", &m_detailSampleDist, 0.0f, 128.0f, 1.0f);
	imguiSlider("Max Sample Error", &m_detailSampleMaxError, 0.0f, 128.0f, 1.0f);
