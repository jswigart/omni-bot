...
if (${XCODE_VERSION_MAJOR} == "0300") then
    cp -fp "${SRCROOT}"/build/Default/libWm5Physicsd.dylib ../SDK/Library/DebugDLL/libWm5Physicsd.dylib
endif
if (${XCODE_VERSION_MAJOR} == "0400") then
    cp -fp "${BUILT_PRODUCTS_DIR}"/libWm5Physicsd.dylib ../SDK/Library/DebugDLL/libWm5Physicsd.dylib
endif
