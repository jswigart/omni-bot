...
WM5_IMPLEMENT_RTTI(Wm5, VisualEffect, Texture2MulEffect);
WM5_IMPLEMENT_STREAM(Texture2MulEffect);
WM5_IMPLEMENT_FACTORY(Texture2MulEffect);
WM5_IMPLEMENT_DEFAULT_NAMES(VisualEffect, Texture2MulEffect);

//----------------------------------------------------------------------------
Texture2MulEffect::Texture2MulEffect ()
{
    VertexShader* vshader = new0 VertexShader("Wm5.Texture2Mul",
        3, 3, 1, 0, false);
    ...
    PixelShader* pshader = new0 PixelShader("Wm5.Texture2Mul",
        2, 1, 0, 2, false);
...
//----------------------------------------------------------------------------
PixelShader* Texture2MulEffect::GetPixelShader () const
{
    return mTechniques[0]->GetPass(0)->GetPixelShader();
}
//----------------------------------------------------------------------------
VisualEffectInstance* Texture2MulEffect::CreateInstance (Texture2D* texture0,
...
//----------------------------------------------------------------------------
VisualEffectInstance* Texture2MulEffect::CreateUniqueInstance (
...
// Streaming support.
//----------------------------------------------------------------------------
Texture2MulEffect::Texture2MulEffect (LoadConstructor value)
    :
    VisualEffect(value)
{
}
//----------------------------------------------------------------------------
void Texture2MulEffect::Load (InStream& source)
{
    WM5_BEGIN_DEBUG_STREAM_LOAD(source);

    VisualEffect::Load(source);

    WM5_END_DEBUG_STREAM_LOAD(Texture2MulEffect, source);
}
//----------------------------------------------------------------------------
void Texture2MulEffect::Link (InStream& source)
{
    VisualEffect::Link(source);
}
//----------------------------------------------------------------------------
void Texture2MulEffect::PostLink ()
{
...
//----------------------------------------------------------------------------
bool Texture2MulEffect::Register (OutStream& target) const
{
    return VisualEffect::Register(target);
}
//----------------------------------------------------------------------------
void Texture2MulEffect::Save (OutStream& target) const
{
    WM5_BEGIN_DEBUG_STREAM_SAVE(target);

    VisualEffect::Save(target);

    WM5_END_DEBUG_STREAM_SAVE(Texture2MulEffect, target);
}
//----------------------------------------------------------------------------
int Texture2MulEffect::GetStreamingSize () const
{
...
// Profiles.
//----------------------------------------------------------------------------
int Texture2MulEffect::msDx9VRegisters[1] = { 0 };
int Texture2MulEffect::msOglVRegisters[1] = { 1 };
int* Texture2MulEffect::msVRegisters[Shader::MAX_PROFILES] =
{
    0,
    msDx9VRegisters,
    msDx9VRegisters,
...
std::string Texture2MulEffect::msVPrograms[Shader::MAX_PROFILES] =
{
    // VS_NONE
    "",
...
int Texture2MulEffect::msAllPTextureUnits[2] = { 0, 1 };
int* Texture2MulEffect::msPTextureUnits[Shader::MAX_PROFILES] =
{
    0,
    msAllPTextureUnits,
    msAllPTextureUnits,
...
std::string Texture2MulEffect::msPPrograms[Shader::MAX_PROFILES] =
{
    // PS_NONE
    "",
