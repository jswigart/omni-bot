...
WM5_IMPLEMENT_RTTI(Wm5, VisualEffect, Texture2DEffect);
WM5_IMPLEMENT_STREAM(Texture2DEffect);
WM5_IMPLEMENT_FACTORY(Texture2DEffect);
WM5_IMPLEMENT_DEFAULT_NAMES(VisualEffect, Texture2DEffect);

//----------------------------------------------------------------------------
Texture2DEffect::Texture2DEffect (Shader::SamplerFilter filter,
...
//----------------------------------------------------------------------------
PixelShader* Texture2DEffect::GetPixelShader () const
{
    return mTechniques[0]->GetPass(0)->GetPixelShader();
}
//----------------------------------------------------------------------------
VisualEffectInstance* Texture2DEffect::CreateInstance (Texture2D* texture)
    const
{
...
// Streaming support.
//----------------------------------------------------------------------------
Texture2DEffect::Texture2DEffect (LoadConstructor value)
    :
    VisualEffect(value)
{
}
//----------------------------------------------------------------------------
void Texture2DEffect::Load (InStream& source)
{
    WM5_BEGIN_DEBUG_STREAM_LOAD(source);

    VisualEffect::Load(source);

    WM5_END_DEBUG_STREAM_LOAD(Texture2DEffect, source);
}
//----------------------------------------------------------------------------
void Texture2DEffect::Link (InStream& source)
{
    VisualEffect::Link(source);
}
//----------------------------------------------------------------------------
void Texture2DEffect::PostLink ()
{
...
//----------------------------------------------------------------------------
bool Texture2DEffect::Register (OutStream& target) const
{
    return VisualEffect::Register(target);
}
//----------------------------------------------------------------------------
void Texture2DEffect::Save (OutStream& target) const
{
    WM5_BEGIN_DEBUG_STREAM_SAVE(target);

    VisualEffect::Save(target);

    WM5_END_DEBUG_STREAM_SAVE(Texture2DEffect, target);
}
//----------------------------------------------------------------------------
int Texture2DEffect::GetStreamingSize () const
{
...
// Profiles.
//----------------------------------------------------------------------------
int Texture2DEffect::msDx9VRegisters[1] = { 0 };
int Texture2DEffect::msOglVRegisters[1] = { 1 };
int* Texture2DEffect::msVRegisters[Shader::MAX_PROFILES] =
{
    0,
    msDx9VRegisters,
    msDx9VRegisters,
...
std::string Texture2DEffect::msVPrograms[Shader::MAX_PROFILES] =
{
    // VP_NONE
    "",
...
int Texture2DEffect::msAllPTextureUnits[1] = { 0 };
int* Texture2DEffect::msPTextureUnits[Shader::MAX_PROFILES] =
{
    0,
    msAllPTextureUnits,
    msAllPTextureUnits,
...
std::string Texture2DEffect::msPPrograms[Shader::MAX_PROFILES] =
{
    // PP_NONE
    "",
