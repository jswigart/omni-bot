...
vmCvar_t cg_waterRevive;
vmCvar_t cg_bloodFlash;
vmCvar_t cg_drawLocalTime;
vmCvar_t cg_bloodDamageBlend;       // Martin
vmCvar_t cg_drawWeaponIconFlash;    // Martin
vmCvar_t cg_printObjectiveInfo;
vmCvar_t cg_centerView;
...
vmCvar_t cg_ospFonts;
vmCvar_t cg_drawStopwatchSprite;
vmCvar_t cg_drawKillCount;
vmCvar_t cg_drawSpeedometer;
vmCvar_t cg_drawPing;
vmCvar_t cg_goat;
vmCvar_t cg_fraglimit;
...
cvarTable_t cvarTable[] = {
	...
	{ &cg_zoomDefaultFG,                "cg_zoomDefaultFG",             "55",                   CVAR_ARCHIVE },
	...
	{ &cg_uselessNostalgia,             "cg_uselessNostalgia",          "0",                    CVAR_ARCHIVE },
	...
	{ &cg_gameSkill,                    "g_gameskill",                  "3",                    0 },
	{ &cg_medicChargeTime,              "g_medicChargeTime",            "10000",                0 },
	{ &cg_LTChargeTime,                 "g_LTChargeTime",               "30000",                0 },
	{ &cg_engineerChargeTime,           "g_engineerChargeTime",         "30000",                0 },
	{ &cg_soldierChargeTime,            "g_soldierChargeTime",          "20000",                0 },
	...
	{ &cg_waterRevive,                  "g_waterRevive",                "0",                    0 },
	...
	{ &cg_printObjectiveInfo,           "cg_printObjectiveInfo",        "0",                    CVAR_ARCHIVE },
	{ &cg_centerView,                   "g_centerview",                 "0",                    0 },
	...
	{ &cg_goat,                         "cg_goat",                      "0",                    CVAR_ARCHIVE },
	{ &cg_fraglimit,                    "fraglimit",                    "0",                    0 },
...
static void CG_RegisterSounds( void ) {
	...
	// OSP
	cgs.media.countFightSound = trap_S_RegisterSound( "sound/osp/fight.wav" );
	cgs.media.countPrepareSound = trap_S_RegisterSound( "sound/osp/prepare.wav" );
	...
	// generic sound for nadepack, smokegrenade, etc
...
static void CG_RegisterGraphics( void ) {
	...
	for ( i = 0 ; i < NUM_CROSSHAIRS ; i++ ) {
		...
		cgs.media.crosshairShader[i] = trap_R_RegisterShader( va( "gfx/2d/crosshair%c_S4ND", 'a' + i ) );
		if ( !cgs.media.crosshairShader[i] ) {
			cgs.media.crosshairShader[i] = trap_R_RegisterShader( va( "gfx/2d/crosshair%c", 'a' + i ) );
		}

		cg.crosshairShaderAlt[i] = trap_R_RegisterShader( va( "gfx/2d/crosshair%c_alt_S4ND", 'a' + i ) );
		if ( !cg.crosshairShaderAlt[i] ) {
	...
	// icons
	cgs.media.objectiveIcon = trap_R_RegisterShader( "models/multiplayer/treasure/treasure" );
	cgs.media.grenadePackIcon = trap_R_RegisterShader( "icons/iconw_grenade_1_select" );
	cgs.media.smokeGrenadeIcon = trap_R_RegisterShader( "icons/iconw_smokegrenade_1_select" );
