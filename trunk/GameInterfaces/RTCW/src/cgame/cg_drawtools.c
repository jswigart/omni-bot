...
==================
*/
void CG_DrawStringExt( int x, int y, const char *string, float *setColor, qboolean forceColor, qboolean shadow, int charWidth, int charHeight, int maxChars ) {
	vec4_t color;
	const char  *s;
	int xx;
	int cnt;
...
==================
*/
void CG_DrawStringExt3( int x, int y, const char *string, const float *setColor, qboolean forceColor, qboolean shadow, int charWidth, int charHeight, int maxChars ) {
	vec4_t color;
	const char  *s;
	int xx;
	int cnt;
...
void CG_DrawGiantStringColor( int x, int y, const char *s, vec4_t color ) {
	CG_DrawStringExt2( x, y, s, color, qfalse, qtrue, GIANTCHAR_WIDTH, GIANTCHAR_HEIGHT, 0 );
}
// END JOSEPH
