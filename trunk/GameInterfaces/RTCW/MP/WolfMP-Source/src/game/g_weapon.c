...
qboolean LogAccuracyHit( gentity_t *target, gentity_t *attacker ) {
	/*if( !target->takedamage ) {	// Martin comment out
		return qfalse;
	}
...
/*	if( target->client->ps.stats[STAT_HEALTH] <= 0 ) {	// Martin - this was initialy commented out.
		return qfalse;
	}*/
/*
	...
	return qtrue;*/
	// Martin - from AccuricyHit in sandmod
