...
extern	vmCvar_t	g_multikillSound[5];
extern	vmCvar_t	g_humiliationSound[6];
extern	vmCvar_t	g_announcer;
extern	vmCvar_t	g_spreeMessage[10];
extern	vmCvar_t	g_humiliationMessage[6];
