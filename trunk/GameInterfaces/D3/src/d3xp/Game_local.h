...
// Omni-bot - Changed version
#define	GAME_VERSION		"Omni-bot 0.65 beta"
...
// Omni-bot - Added omnibot include
#include "omnibot_interface.h"

// Omni-bot - Added IsTeamGame
ID_INLINE bool idGameLocal::IsTeamGame( void ) const {
	return ( isMultiplayer && ( gameType == GAME_TDM || gameType == GAME_CTF ) );
}
