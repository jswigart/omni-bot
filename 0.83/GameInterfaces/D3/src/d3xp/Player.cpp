...
void idInventory::RestoreInventory( idPlayer *owner, const idDict &dict ) {
	...
	if(owner && omnibot_interface::IsBot(owner->entityNumber))
	{		
...
// Omni-bot - Added AmmoClassForWeaponClass
/*
==============
...
// Omni-bot - Added SelectWeapon( const char *weapon_name )
/*
===============
...
void idPlayer::StealWeapon( idPlayer *player ) {
	...
	omnibot_interface::Bot_Event_RemoveWeapon(player->entityNumber, obUtilGetWeaponId(weapon_classname));
}
...
void idPlayer::Think( void ) {
	...
	if ( !( thinkFlags & TH_THINK ) ) {
		// Omni-bot - Added isbot check
		if( !omnibot_interface::IsBot( entityNumber ) )
...
int idPlayer::GetCurrentWeaponSlot()
{
...
/*#ifdef _D3XP
	...
	if(omnibot_interface::IsBot(entityNumber) && attacker)
	{
