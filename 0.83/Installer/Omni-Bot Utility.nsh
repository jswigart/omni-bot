...
Function un.GetCmdLineParameter
  Exch $3
...
; ---------------------------------------------------------------
; since unintall blocks apparantly need un. in front of functions
; we get to recreate the entire function ...
...
Exch $R0
FunctionEnd
!macro UnStrStrip Str InStr OutVar
 Push '${InStr}'
 Push '${Str}'
  Call un.StrStrip
 Pop '${OutVar}'
!macroend
!define UnStrStrip '!insertmacro UnStrStrip'